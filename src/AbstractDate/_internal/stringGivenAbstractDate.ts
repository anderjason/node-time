...
export function stringGivenAbstractDate(
  date: AbstractDate,
  ...
  switch (format) {
    case "January 1, 2020":
      return `${nameGivenCalendarMonth(date.calendarMonth, "January")} ${
        date.calendarDay
      }, ${date.calendarYear}`;
    case "January 1":
      return `${nameGivenCalendarMonth(date.calendarMonth, "January")} ${
    ...
    case "Jan 1 2020":
      return `${nameGivenCalendarMonth(date.calendarMonth, "Jan")} ${
        date.calendarDay
      } ${date.calendarYear}`;
    case "Jan 01 2020":
      return `${nameGivenCalendarMonth(date.calendarMonth, "Jan")} ${padDay} ${
        date.calendarYear
      }`;
    case "Jan 1":
      return `${nameGivenCalendarMonth(date.calendarMonth, "Jan")} ${
